  ...
  return (
    <Container className="py-10 sm:py-14 grid gap-8">
      <section className="grid gap-4">
        ...
        <h1 className="text-3xl font-black tracking-tight sm:text-4xl">Solicitar asesoría para mi clínica</h1>
        <p className="max-w-3xl text-sm text-black/65 dark:text-white/70 sm:text-base">
          Clinica Estetica reúne agenda online, orientación inicial para atención prioritaria, portal para pacientes y un panel operativo para el equipo.
